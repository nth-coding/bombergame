...
public class Sprite {
    ...
    public static Sprite mob_dead_1 = new Sprite(DEFAULT_SIZE, 15, 0,  SpriteSheet.tiles, 16, 16);
    public static Sprite mob_dead_2 = new Sprite(DEFAULT_SIZE, 15, 1, SpriteSheet.tiles, 16, 16);
    public static Sprite mob_dead_3 = new Sprite(DEFAULT_SIZE, 15, 2, SpriteSheet.tiles, 16, 16);
